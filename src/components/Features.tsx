      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-24">
          <div className="relative">
            <div className="absolute -inset-1 rounded-lg bg-gradient-to-r from-brand-600/30 to-purple-600/30 blur-lg"></div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-24">
          ...
          <div className="order-1 lg:order-2 relative">
            <div className="absolute -inset-1 rounded-lg bg-gradient-to-r from-purple-600/30 to-brand-600/30 blur-lg"></div>
            <div className="relative overflow-hidden rounded-lg shadow-lg">
              <img
